...
![Confirming location of text file]({{"/assets/ctf/gctf-2025/Web/my-fav-reporting-engine-v2-1.png" | relative_url}})
4. Since cat is also blacklisted, we can use alternative commands to view the contents of the text file, such as head. <br>
![Viewing flag]({{"/assets/ctf/gctf-2025/Web/my-fav-reporting-engine-v2-2.png" | relative_url}})
![The flag]({{"/assets/ctf/gctf-2025/Web/my-fav-reporting-engine-v2-3.png" | relative_url}})
