...
![Listing SMB shares]({{"/assets/ctf/picoctf-2026/General/printer-shares-2-1.png" | relative_url}}) <br><br>
2. Then, I connected to the public share and downloaded the available files. <br>
![Connecting to public SMB share]({{"/assets/ctf/picoctf-2026/General/printer-shares-2-2.png" | relative_url}}) <br><br>
3. There wasn’t anything interesting in `content.txt` and `kafka.txt`, but I found a clue in `notification.txt`: <br>
![notification.txt]({{"/assets/ctf/picoctf-2026/General/printer-shares-2-3.png" | relative_url}}) <br><br>
...
![Password cracking]({{"/assets/ctf/picoctf-2026/General/printer-shares-2-4.png" | relative_url}}) <br><br>
5. I successfully cracked Joe’s password, "popcorn" and used it to connect to the private share. <br>
![Connecting to private SMB share]({{"/assets/ctf/picoctf-2026/General/printer-shares-2-5.png" | relative_url}}) <br><br>
