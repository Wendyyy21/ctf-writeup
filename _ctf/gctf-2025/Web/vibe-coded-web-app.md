...
![Verifying number of columns]({{"/assets/ctf/gctf-2025/Web/vibe-coded-web-app-1.png" | relative_url}})
5. Next, we can list the user-created tables in the database. <br>
![Listing user-created tables]({{"/assets/ctf/gctf-2025/Web/vibe-coded-web-app-2.png" | relative_url}}g)
6. Our flag is most likely in the table called "flags", so list the fields in this table. <br>
![Listing fields in flags table]({{"/assets/ctf/gctf-2025/Web/vibe-coded-web-app-3.png" | relative_url}})
7. Lastly, retrieve the flag. <br>
![Retrieving flag]({{"/assets/ctf/gctf-2025/Web/vibe-coded-web-app-4.png" | relative_url}})
