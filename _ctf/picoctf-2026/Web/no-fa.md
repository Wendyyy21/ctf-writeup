...
![Records for 20 users]({{"/assets/ctf/picoctf-2026/Web/no-fa-1.png" | relative_url}}) <br><br>
2. I pasted the 20 hashes into crackstation.net and got the passwords for two users: john.doe and admin. <br>
![crackstation]({{"/assets/ctf/picoctf-2026/Web/no-fa-2.png" | relative_url}}) <br><br>
...
![Found OTP]({{"/assets/ctf/picoctf-2026/Web/no-fa-3.png" | relative_url}}) <br><br>
