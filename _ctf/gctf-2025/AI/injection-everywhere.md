...
![We can trick the chatbot into believing that we are an admin]({{"/assets/ctf/gctf-2025/AI/Injection_Everywhere1.png" | relative_url}})
...
![Get the flag]({{"/assets/ctf/gctf-2025/AI/Injection_Everywhere2.png" | relative_url}})
