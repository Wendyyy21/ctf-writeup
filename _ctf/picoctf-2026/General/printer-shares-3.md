...
![Listing SMB shares]({{"/assets/ctf/picoctf-2026/General/printer-shares-3-1.png" | relative_url}}) <br><br>
2. Then, I connected to the public share and downloaded the available files. <br>
![Connecting to public SMB share]({{"/assets/ctf/picoctf-2026/General/printer-shares-3-2.png" | relative_url}}) <br><br>
...
![ls ../ > parent.txt]({{"/assets/ctf/picoctf-2026/General/printer-shares-3-3.png" | relative_url}}) <br><br>
6. After confirming the path to the private share, I listed the contents of the private share. <br>
![ls ../secure-shares/ > private.txt]({{"/assets/ctf/picoctf-2026/General/printer-shares-3-4.png" | relative_url}}) <br><br>
7. Lastly, I copied the contents of the flag file from the private share to the public share. <br>
![cp ../secure-shares/flag.txt > flag.txt]({{"/assets/ctf/picoctf-2026/General/printer-shares-3-5.png" | relative_url}})
