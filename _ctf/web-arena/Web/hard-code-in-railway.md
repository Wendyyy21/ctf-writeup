...
![Token in source code]({{"/assets/ctf/web-arena/Web/hard-code-in-railway-1.png" | relative_url}})
2. It looks like a flag, but it has the wrong format (doesn’t begin with STURSEC). Moving on, I also see a comment with a “hint”.
 ![Hint in source code]({{"/assets/ctf/web-arena/Web/hard-code-in-railway-2.png" | relative_url}})
...
5. And that’s when I saw the flag in one of the functions. Alternatively, it can be viewed in the console as well.
 ![Flag found in JS]({{"/assets/ctf/web-arena/Web/hard-code-in-railway-3.png" | relative_url}})
