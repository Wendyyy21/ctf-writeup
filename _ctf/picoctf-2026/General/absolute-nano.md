...
![Current user permissions]({{"/assets/ctf/picoctf-2026/General/absolute-nano-1.png" | relative_url}})
3. I edited `/etc/sudoers` to allow ctf-player to run `nano` on all files. <br>
![Edit sudoers]({{"/assets/ctf/picoctf-2026/General/absolute-nano-2.png" | relative_url}})
