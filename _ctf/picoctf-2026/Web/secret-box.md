...
![Flag is in secrets table]({{"/assets/ctf/picoctf-2026/Web/secret-box-1.png" | relative_url}}) <br><br>
...
![Error message]({{"/assets/ctf/picoctf-2026/Web/secret-box-2.png" | relative_url}}) <br><br>
...
![admin's password]({{"/assets/ctf/picoctf-2026/Web/secret-box-3.png" | relative_url}}) <br>
![Flag]({{"/assets/ctf/picoctf-2026/Web/secret-box-4.png" | relative_url}}) <br>
